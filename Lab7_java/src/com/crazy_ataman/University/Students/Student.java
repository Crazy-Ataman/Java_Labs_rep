...
abstract public class Student {
    ...
    public void setAcademic_perf(int academic_perf) {
    ...
    public Student(String name, String surname, String form_of_ed, Course course, int academic_perf, int missed_hours, int scholarship) {
        setName(name);
        setSurname(surname);
